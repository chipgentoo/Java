    ...
    static class Render {
        ...
        public void showIndicator(Object object) {
            ...
            if (object instanceof HealthImpl){
                ...
                System.out.println(getColor(curHealth) + "Текущей уровень здоровья:" + curHealth + ANSI_RESET);
            }
            if (object instanceof ManaImpl){
                ...
                System.out.println(getColor(curMana) + "Текущей уровень маны:" + curMana + ANSI_RESET);
            }
        } // end showIndicator
